...
<% try{
	...
	List<String[]> getDiscounts = SQLData.getDiscounts(id);
	String[] disc = getDiscounts.get(0);
	String amnth = disc[6].replace("%", "");
%>
<!DOCTYPE html>
<html lang="en">
  <head>
              ...
              <div class="card d-flex">
                <form class="card-body">
                  ...
                  <div class="form-outline mb-4">
                    <input type="text" id="discountName" class="form-control" value="<%=disc[1]%>" disabled />
