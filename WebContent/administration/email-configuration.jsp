...
try{
	...
	List<String[]> email = SQLData.getContent("Email");
	%>
	<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <script type="text/javascript">
	function editEntry(contentID) {
		window.location = "edit-email-configuration.jsp?contentID="+contentID;
	}
	</script>
  <body
    class="sb-nav-fixed"
            ...
            <div class="row">
              ...
              <div class="card mb-4 ms-3 px-3 d-flex">
                <div class="card-header">
                 ...
                 <% Message m1=(Message) session.getAttribute("msgEditEmail");
					  			if(m1!=null){
					  		...
					  		%>
					  		<%session.removeAttribute("msgEditEmail"); %>
                <div class="card-body">
                  <table id="datatablesSimple">
                    ...
                    <%
                    	for(int i = 0; i < email.size(); i++){
                    		out.print("<tr>");
                    		out.print("<td>"+email.get(i)[0]+"</td>");
                    		out.print("<td>"+email.get(i)[1]+"</td>");
                    		out.print("<td>"+email.get(i)[2]+"</td>");
                    		out.print("<td>"+email.get(i)[3]+"</td>");
                    		out.print("<td>"+email.get(i)[4]+"</td>");
                    		out.print("<td>"+email.get(i)[5]+"</td>");
                    		out.print("<td>"+email.get(i)[6]+"</td>");
                    		out.print("<td><Button type='button' class='btn btn-dark' onclick=\"editEntry('"+email.get(i)[0]+"')\" > Edit </Button></td>");
                    		out.print("</tr>");
                    	}
                    %>
