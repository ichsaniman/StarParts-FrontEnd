...
<html lang="en">
  ...
  function myFunction() {
		...
		if (id == 'CID002'){
			...
			contentArea = tinymce.get("mailedit").getContent({ format: "text" });
		}
		else{
			contentArea = tinyMCE.get('mailedit').getContent();
		}
		  console.log(id);
          ...
          <div class="container-fluid px-2">
            ...
            <div class="row">
              <div class="card d-flex">
               <form class="card-body"  action="${pageContext.request.contextPath}/EditEmail" method="post" >
                  <% Message m1=(Message) session.getAttribute("1321");
					  			if(m1!=null){
                  ...
                  <div class="form-outline mb-4">
                    ...
                    <label class="form-label" for="Description"
                      >Email body content for E-Statement
                    </label>
                  </div>
                  <div class="form-outline mb-4">
                    <textarea
                    ...
                    <label class="form-label" for="mailedit"
