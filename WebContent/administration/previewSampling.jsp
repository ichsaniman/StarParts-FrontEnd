                ...
                Interface
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="layout-static.html" style="color: #ffffff">Generate PDF</a>
                                <a class="nav-link" href="content.html" style="color: #ffffff">Content Configuration</a>
                                <a class="nav-link" href="layout-static.html" style="color: #ffffff">Preview
                                    Sampling</a>
                                <a class="nav-link" href="layout-static.html" style="color: #ffffff">User Management</a>
                            </nav>
                        </div>
                        <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapse"
                            aria-expanded="false" aria-controls="collapseLayouts" style="color: #ffffff">
                            <div class="sb-nav-link-icon">
                        ...
                        <div class="collapse" id="collapse" aria-labelledby="headingOne"
                            data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="layout-static.html" style="color: #ffffff">Customers PDF
                                    Data</a>
                                <a class="nav-link" href="layout-sidenav-light.html" style="color: #ffffff">Send
                                    Email</a>
                                <a class="nav-link" href="layout-static.html" style="color: #ffffff">Email Report</a>
                            </nav>
                        </div>
                    </div>
                </div>
        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Preview Sampling</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <!-- </div>
                            <div class="col"> -->
                            <button type="button" class="btn btn-success"><i class="far fa-paper-plane fa-fw"></i>Download all</button>
