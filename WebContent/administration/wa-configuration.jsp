  ...
  <head>
   ...
   function myFunction() {
		...
		var id = document.getElementById('id').value;
		 ...
		 $.ajax({
				method: "POST",
				url: "${pageContext.request.contextPath}/EditWA",
         ...
         <div class="container-fluid px-2">
            ...
            <div class="row">
              <div class="card d-flex">
                <form class="card-body" action="${pageContext.request.contextPath}/EditWA" method="post" >
                  <% Message m1=(Message) session.getAttribute("msgEditWA");
					  			if(m1!=null){
					  		...
					  		%>
					  		<%session.removeAttribute("msgEditWA"); %>
                  <!-- Text input -->
            
                  <div class="form-outline mb-4">
                    <input type="text" id="IDContent" class="form-control" value="<%=disp %>" disabled/>
                    <input type="hidden" id="id" value="<%=id %>"/>
                    <label class="form-label" for="IDContent">IDContent</label>
                  </div>
                  <!-- <div class="form-outline mb-4">
