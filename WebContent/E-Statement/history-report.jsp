                    ...
                    <form action="">
                                                    ...
                                                    <tbody>
                                                    	...
                                                    	for(int i = 0; i<customer.size(); i++){
                                                    		...
                                                    		if(status.equals("R") && !message.equals("Ready to Send")){
                                                    			...
                                                    			out.print("<td class='tg-0lax'>Succes Send Email</td>");                                                    			
                                                    			out.print("<td class='tg-0lax'><button type='button' class='btn btn-success' name='download' value='"+customer.get(i)[0]+"' disabled ><i class='fas fa-check fa-fw'></i></button></td>");
                                                    		}
                                                    		out.print("</tr>");
                                                    	}
                                                    %>
                        ...
                        <div class="row">
                            ...
                            <button type="button" class="btn btn-warning"><i
                                    class="far fa-file-archive fa-fw"></i>Re-Send Email 
                                All</button>
                            <!-- </div>
                            <div class="col"> -->
